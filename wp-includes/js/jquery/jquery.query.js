 ...
 **/
!function(e) {
  var t = e.separator || "&", l = !1 !== e.spaces,
  ...
  jQuery.query = new function() {
    ...
    function r(e) {
      ...
      return n.keys = {},
             e.queryObject
                 ? jQuery.each(e.get(), function(e, t) { n.SET(e, t) })
    ...
    return r.prototype = {
      ...
      GET : function(e) {
        if (!c(e))
          return this.keys;
        for (var e = u(e), t = e[0], n = e[1], r = this.keys[t];
             null != r && 0 != n.length;)
          r = r[n.shift()];
      ...
      get : function(e) {
        e = this.GET(e);
        return c(e, Object)  ? jQuery.extend(!0, {}, e)
               : c(e, Array) ? e.slice(0)
                             : e
      },
      SET : function(e, t) {
        var n, r;
        return e.includes("__proto__") || e.includes("constructor") ||
                   e.includes("prototype") ||
                   (t = c(t) ? t : null, n = (e = u(e))[0], e = e[1],
                    r = this.keys[n], this.keys[n] = o(r, e.slice(0), t)),
               this
      },
      set : function(e, t) { return this.copy().SET(e, t) },
      REMOVE : function(e, t) {
        if (t) {
          var n = this.GET(e);
          if (c(n, Array)) {
      ...
      remove : function(e, t) { return this.copy().REMOVE(e, t) },
      EMPTY : function() {
        var n = this;
        return jQuery.each(n.keys, function(e, t) { delete n.keys[e] }), n
      },
      load : function(e) {
        var t = e.replace(/^.*?[#](.+?)(?:\?.+)?$/, "$1"),
            n = e.replace(/^.*?[?](.+?)(?:#.+)?$/, "$1");
        return new r(e.length == n.length ? "" : n,
                     e.length == t.length ? "" : t)
      },
      ...
      COMPACT : function() {
        return this.keys = function r(e) {
          ...
          return "object" == typeof e && jQuery.each(e, function(e, t) {
            if (!c(t))
              return !0;
            var n;
      ...
      toString : function() {
        ...
        return u(this.keys), 0 < i.length && e.push(n), e.push(i.join(t)),
               e.join("")
      }
    },
